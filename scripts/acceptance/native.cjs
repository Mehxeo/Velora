...
(async()=>{
 ...
 assert.equal(manifest.desktopSourceCommit,'b271db887635e69fb9c6285477ed20be77d38bd2');
 ...
 if(process.platform==='darwin'){
  ...
  const old=`Velora-3.0.0-alpha.82.2.1${suffix}-mac.zip`;download('v3.0.0-alpha.82.2.1',previous,old);
  ...
  const old=`Velora-Setup-3.0.0-alpha.82.2.1-x64.exe`;const installer=windowsCandidate;
  download('v3.0.0-alpha.82.2.1',previous,old);download(tag,candidate,installer);verify(installer);
